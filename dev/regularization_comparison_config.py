...
configs = 7
output_types = 1#DON'T FORGET TO UPDATE THIS WITH THE OTHERS
run_count = 4
epochs = 20
...
comparison_title="regularization rates"
comparison_file="regularization_rate_comparison"
'''
        ...
        for output_type in range(output_types):
            ...
            for r in config_results:
                ...
                if int(r) >= run_count:
                    ...
                    plt.plot(x, y, c=str(config_num*1.0/configs), ls='--')
